...
namespace Ml2.Asstn
{
  ...
  public class FilteredAssociator<T> : BaseAssociation<T, FilteredAssociator> where T : new()
  {
    ...
    /// </summary>    
    public FilteredAssociator<T> Filter (Fltr.IBaseFilter<T, weka.filters.Filter> value) {
    ...
    /// </summary>    
    public FilteredAssociator<T> Associator (Asstn.IBaseAssociation<weka.associations.AbstractAssociator> value) {
