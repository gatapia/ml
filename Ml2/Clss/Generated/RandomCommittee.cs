...
namespace Ml2.Clss
{
  ...
  /// </summary>
  public class RandomCommittee<T> : BaseClassifier<T, RandomCommittee>
  {
    ...
    /// </summary>    
    public RandomCommittee<T> Classifier (Clss.BaseClassifier<T, weka.classifiers.Classifier> newClassifier) {
