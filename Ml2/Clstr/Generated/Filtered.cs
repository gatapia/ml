...
namespace Ml2.Clstr
{
  ...
  {    
    ...
    /// </summary>    
    public Filtered<T> Filter (Fltr.IBaseFilter<T, weka.filters.Filter> filter) {
    ...
    /// </summary>    
    public Filtered<T> Clusterer (Clstr.IBaseClusterer<T, weka.clusterers.Clusterer> value) {
