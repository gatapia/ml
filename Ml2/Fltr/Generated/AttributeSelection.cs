...
namespace Ml2.Fltr
{
  ...
  public class AttributeSelection<T> : BaseFilter<T, AttributeSelection> where T : new()
  {
    ...
    /// </summary>    
    public AttributeSelection<T> Evaluator (AttrSel.Evals.IBaseAttributeSelectionEvaluator<weka.attributeSelection.ASEvaluation> evaluator) {
    ...
    /// </summary>    
    public AttributeSelection<T> Search (AttrSel.Algs.IBaseAttributeSelectionAlgorithm<weka.attributeSelection.ASSearch> search) {
