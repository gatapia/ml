...
namespace Ml2.Fltr
{
  ...
  /// </summary>
  public class MergeTwoValues<T> : BaseFilter<T, MergeTwoValues>
  {
    ...
    /// 
    /// </summary>    
    public MergeTwoValues<T> InputFormat (Runtime<T> instanceInfo) {
      ((MergeTwoValues)Impl).setInputFormat(instanceInfo.Instances);
      return this;
    }
