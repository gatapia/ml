...
namespace Ml2.Fltr
{
  ...
  /// class))<br/>
  /// </summary>
  public class SMOTE<T> : BaseFilter<T, SMOTE> where T : new()
  {
    public SMOTE(Runtime<T> rt) : base(rt, new SMOTE()) {}

    /// <summary>
    /// The percentage of SMOTE instances to create.
    /// </summary>    
    public SMOTE<T> Percentage (double value) {
      ((SMOTE)Impl).setPercentage(value);
      return this;
    }
    ...
    /// </summary>    
    public SMOTE<T> NearestNeighbors (int value) {
      ((SMOTE)Impl).setNearestNeighbors(value);
      return this;
    }
    ...
    /// </summary>    
    public SMOTE<T> ClassValue (string value) {
      ((SMOTE)Impl).setClassValue(value);
      return this;
    }
